...
<section class="banner" role="banner">
  ...
  <div class="container">
	...
	<div class="form-group">
		<a href="listetacheproduction.php#contact" class="btn  btn-block">Liste des taches</a>
		</div>
  ...
  <div class="container">
    <div class="row">
	  ...
	  <div class="conForm">
        ...
        <p>Affecter une tache au Département Production</p>
      </div>
        <form method="post" action="addtache.php">
		<div class="form-group">
      <label for="pwd">Département:</label>
      <input type="text" class="form-control" Value="Département Production" name="departement" id="departement" readonly>
    </div>
		  <div class="form-group">
  <label for="sel1">Nom:</label>
  <select class="form-control" name="nomprenom" id="nomprenom">
    <option value="Nicolas Niox">François Nicolas Niox</option>
    <option value="Mehdi Atemni">Mehdi Atemni</option>
