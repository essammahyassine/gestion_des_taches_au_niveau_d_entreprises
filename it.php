...
<section class="banner" role="banner">
  ...
  <div class="container">
    ...
    <a href="it.php#contact" class="btn btn-block">Affecter une tache</a> 
    </div>
	<div class="form-group">
		<a href="listetacheit.php#contact" class="btn  btn-block">Liste des taches</a>
		</div>
		</div>
...
<section id="contact" class="section">
  <div class="container">
    <div class="row">
      ...
      <input type="text" class="form-control" Value="Département IT" name="departement" id="departement" readonly>
    </div>
		  <div class="form-group">
  <label for="sel1">Nom:</label>
  <select class="form-control" name="nomprenom" id="nomprenom">
    <option value="Mohammed Zouhri">Mohammed Zouhri</option>
    <option value="Yassine Es Sammah">Yassine Es Sammah</option>
