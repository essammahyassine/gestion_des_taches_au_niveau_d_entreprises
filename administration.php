  ...
  <div class="container">
    <div class="col-md-10 col-md-offset-1">
     ...
     <h1>Kglink call center</h1>
        <p>Département Administratif</p>
	
         <div class="form-group">
    <a href="administration.php#contact" class="btn btn-block">Affecter une tache</a> 
    </div>
	<div class="form-group">
		<a href="listetacheadministration.php#contact" class="btn  btn-block">Liste des taches</a>
		</div>
    </div>
  </div>
</section>
...
<section id="contact" class="section">
  <div class="container">
    <div class="row">
	  ...
	  <div class="conForm">
        <h5>Département Administratif</h5>
        <p>Affecter une tache au Département Administratif</p>
      </div>
        <form method="post" action="addtache.php">
		   <div class="form-group">
      <label for="pwd">Département:</label>
      <input type="text" class="form-control" Value="Département Administratif" name="departement" id="departement" readonly>
    </div>
		  
		  <div class="form-group">
  <label for="sel1">Nom:</label>
  <select class="form-control" name="nomprenom" id="nomprenom">
    <option value="Ikram EL Hamdaoui">Ikram EL Hamdaoui</option>
