...
<section class="banner" role="banner">
  ...
  <div class="container">
    ...
    <a href="qualite.php#contact" class="btn btn-block">Affecter une tache</a> 
    </div>
	<div class="form-group">
  ...
  <div class="container">
    <div class="row">
	  ...
	  <div class="conForm">
        ...
        <p>Liste des taches du Département Qualité</p>
      </div>
            <div class="row">
                <div class="col-sm-12">
...
<div class="">
  ...
  <thead>
					...
					<?php
								...
								$sql = "select * FROM gestiontache where departement='Département Qualité' ORDER BY id desc" ;
