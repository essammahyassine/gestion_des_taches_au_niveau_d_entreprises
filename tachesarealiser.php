...
<section class="banner" role="banner">
  <header id="header">
    <div class="header-content clearfix"> <a class="logo" href="mestaches.php">Kglink</a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="mestaches.php">Taches</a></li>
          <li><a href="tachesrealiser.php">Taches réaliser</a></li>
		  <li><a href="tachesarealiser.php">Taches a réaliser</a></li>
  ...
  <div class="container">
    <div class="row">
	  ...
	  <div class="conForm">
        ...
        <p>Kglink - Gestion des taches : <?php echo $test;?></p>
      </div>
            <div class="row">
                <div class="col-sm-12">
...
<div class="">
  ...
  <thead>
					  ...
					  <td>
					  <p style='color:#6c7279;'>Délivrer</p>
					  </td>
                     </tr>
					  </thead>
					                          <tbody>
					<?php
								...
								$sql = "select * FROM gestiontache where nomprenom='$test' and etat='Non effectuer' ORDER BY id desc" ;
    foreach  ($bdd->query($sql) as $row) {
			   ...
			   <tr>
							...
							<td><a href="./updatetache.php?id=<?php echo $row['id']; ?>" class="button btn-primary" >Délivrer</a></td>
      ...
      <div class="row">
        ...
        <div class="footer-col col-md-3">
          ...
          <ul>
            ...
            <li><a href="tachesrealiser.php">Taches Réaliser</a></li>
            <li><a href="tachesarealiser.php">Taches à Réaliser</a></li>
